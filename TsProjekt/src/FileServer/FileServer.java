...
public class FileServer {
    ...
    public static void main(String[] args) {
        MicroserviceManager microserviceAgent = MicroserviceManager.getInstance(); // Get instance of ManagerAgent
        int port = microserviceAgent.getMicroservicePort("FileServer"); // Retrieve the port number for this microservice

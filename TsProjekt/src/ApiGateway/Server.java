...
class ApiGateway {
    public static void main(String[] args) {
        ...
        MicroserviceManager agent = MicroserviceManager.getInstance(); // Get the singleton instance of MicroserviceManager

        try (ServerSocket server = new ServerSocket(agent.getApiPort())) {
